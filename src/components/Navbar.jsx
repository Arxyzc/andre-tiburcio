...
import LanguageSwitcher from './LanguageSwitcher'; // Importa el selector de idioma
                            ...
                            <ul className="flex items-center gap-4">
                                {NAVIGATION_LINKS.map((item, index) => (
                                    <li key={index}>
                                        ...
                                        >
                                            {t(item.label)} {/* Usando la función de traducción */}
                                        </a>
                                    </li>
                                ))}
                            </ul>
                        </div>
                        <LanguageSwitcher /> {/* Añade el selector de idioma */}
                    </div>
                </div>
                {/* MOBILE MENU */}
                <div className="rounded-lg backdrop-blur-md lg:hidden">
                    ...
                    {isMobileMenuOpen && (
                        <ul className="ml-4 mt-4 flex flex-col gap-4 backdrop-blur-md">
                            ...
                            <LanguageSwitcher /> {/* Añade el selector de idioma en el menú móvil */}
                        </ul>
                    )}
                </div>
            </nav>
